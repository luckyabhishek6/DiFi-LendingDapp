      ...
      {isLendEther ? (
        <div>
          ...
          <div className="mt-5">
            <a
              ...
              href={"https://ropsten.etherscan.io/tx/" + information.hash}
        ...
        <div>
          {isDone ? (
            ...
            <div>
              <div>Lend amount: {information.amount} LUCKY</div>
            ...
            <div>
              ...
              <div className="my-2">
                Approve amount: {information.amount} LUCKY
              </div>
              <div className="my-2">
                {" "}
          ...
          <div>
            ...
            {!isValidLendAmount && (
              <div className="p-0 flex justify-center items-center text-red-500">
                <AiFillWarning className="mr-2" />
                <div>Minimum lend amount 0.0001 ETH or 1 LUCKY token</div>
              </div>
            )}
            {!isEnoughFund && (
              <div className="p-0 flex justify-center items-center text-red-500">
