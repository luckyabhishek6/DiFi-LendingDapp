          ...
          <div>
            <div>
              ...
              <a
                ...
                href={"https://ropsten.etherscan.io/tx/" + withdrawDetails.hash}
        ...
        {!data.isLendEther && (
          <div>
            <div className="">
              ...
              <p className="break-words">
                {data.paybackAmountToken.toString() / 10 ** 18} LUCKY
              </p>
            </div>
            <div className="">
              <p className="font-bold text-white underline">Lend LUCKY amount</p>{" "}
              <p className="break-words">
                {data.lendAmountToken.toString() / 10 ** 18} LUCKY
              </p>
            </div>
          </div>
        )}
      ...
      <div>
        <div>
          ...
          <div className="">
            ...
            <p className="break-words">
              {data.collateralAmount.toString() / 10 ** 18} LUCKY
            </p>
          </div>
        </div>
      </div>
